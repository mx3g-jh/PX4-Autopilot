...
/* battery link checkout */
#define BOARD_HAS_POWER_CONTROL	1
#define BOARD_HAS_POWER_CHECK	1

/* RC */
#define GPIO_PCON_RADIO  (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_SPEED_2MHz|GPIO_OUTPUT_SET|GPIO_PORTG|GPIO_PIN5)
...
//Disable Zigbee port and function if has OFDM.
#ifndef TAP_HAS_OFDM
